...
- 🤖 [**Jobpilot-Autopilot for Job Applications**](https://github.com/gokmeroz/jobpilot-autopilot-for-job-applications) - Discover fresh jobs, score them against your resume, auto-apply where possible, track everything in Google Sheets, and generate application reports—all on autopilot.
